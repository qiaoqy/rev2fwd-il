"""RL environment wrapper for Isaac Lab pick-place.

Wraps the Isaac Lab gym environment into a standard interface for RL training,
...
def load_pretrained_diffusion_policy(
    ...
    """Load a pretrained Diffusion Policy for RL finetuning.
