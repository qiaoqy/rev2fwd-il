...
## Copied from lerobot
## /mnt/dongxu-fs1/data-ssd/qiyuanqiao/workspace/lerobot/src/lerobot/policies/diffusion/modeling_diffusion.py
...
class DiffusionModel(nn.Module):
    ...
    def compute_loss(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        #TODO : element wise product the value to the action when action loss is calculated.
